...
import { cityCatalogCollectionHandler, cityCatalogHandler, cityCatalogSearchHandler, prewarmCityHomeCatalogs } from "./catalog.js";
...
app.get("/api/catalog/:cityId/collections/:collection", cityCatalogCollectionHandler);
