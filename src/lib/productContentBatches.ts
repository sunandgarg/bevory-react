...
export const productContentBatchVersion = (slug: string): string | null =>
  slug in BATCH_44 ? "researched-product-batch-44" : slug in BATCH_43 ? "researched-product-batch-43" : slug in BATCH_42 ? "researched-product-batch-42" : slug in BATCH_41 ? "researched-product-batch-41" : slug in BATCH_40 ? "researched-product-batch-40" : productContentBatchVersionThrough39(slug);
