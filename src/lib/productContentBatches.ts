...
import { PRODUCT_BATCH_CONTENT as BATCH_44 } from "./productContentBatch44.js";
import { PRODUCT_BATCH_CONTENT as BATCH_45 } from "./productContentBatch45.js";
import { PRODUCT_BATCH_CONTENT as BATCH_46 } from "./productContentBatch46.js";
import { PRODUCT_BATCH_CONTENT as BATCH_47 } from "./productContentBatch47.js";
import { PRODUCT_BATCH_CONTENT as BATCH_48 } from "./productContentBatch48.js";
import { PRODUCT_BATCH_CONTENT as BATCH_49 } from "./productContentBatch49.js";
import { PRODUCT_BATCH_CONTENT as BATCH_50 } from "./productContentBatch50.js";
import { PRODUCT_BATCH_CONTENT as BATCH_51 } from "./productContentBatch51.js";

export const PRODUCT_BATCH_CONTENT = { ...BATCH_01, ...BATCH_02, ...BATCH_03, ...BATCH_04, ...BATCH_05, ...BATCH_06, ...BATCH_07, ...BATCH_08, ...BATCH_09, ...BATCH_10, ...BATCH_11, ...BATCH_12, ...BATCH_13, ...BATCH_14, ...BATCH_15, ...BATCH_16, ...BATCH_17, ...BATCH_18, ...BATCH_19, ...BATCH_20, ...BATCH_21, ...BATCH_22, ...BATCH_23, ...BATCH_24, ...BATCH_25, ...BATCH_26, ...BATCH_27, ...BATCH_28, ...BATCH_29, ...BATCH_30, ...BATCH_31, ...BATCH_32, ...BATCH_33, ...BATCH_34, ...BATCH_35, ...BATCH_36, ...BATCH_37, ...BATCH_38, ...BATCH_39, ...BATCH_40, ...BATCH_41, ...BATCH_42, ...BATCH_43, ...BATCH_44, ...BATCH_45, ...BATCH_46, ...BATCH_47, ...BATCH_48, ...BATCH_49, ...BATCH_50, ...BATCH_51 };
export const productContentBatchVersion = (slug: string): string | null =>
  slug in BATCH_51 ? "researched-product-batch-51" : slug in BATCH_50 ? "researched-product-batch-50" : slug in BATCH_49 ? "researched-product-batch-49" : slug in BATCH_48 ? "researched-product-batch-48" : slug in BATCH_47 ? "researched-product-batch-47" : slug in BATCH_46 ? "researched-product-batch-46" : slug in BATCH_45 ? "researched-product-batch-45" : slug in BATCH_44 ? "researched-product-batch-44" : slug in BATCH_43 ? "researched-product-batch-43" : slug in BATCH_42 ? "researched-product-batch-42" : slug in BATCH_41 ? "researched-product-batch-41" : slug in BATCH_40 ? "researched-product-batch-40" : productContentBatchVersionThrough39(slug);
