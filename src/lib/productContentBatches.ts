...
export const PRODUCT_BATCH_CONTENT = { ...BATCH_01, ...BATCH_02, ...BATCH_03, ...BATCH_04, ...BATCH_05, ...BATCH_06 };
export const productContentBatchVersion = (slug: string): string | null =>
  slug in BATCH_06 ? "researched-product-batch-06" : slug in BATCH_05 ? "researched-product-batch-05" : slug in BATCH_04 ? "researched-product-batch-04" : slug in BATCH_03 ? "researched-product-batch-03" : slug in BATCH_02 ? "researched-product-batch-02" : slug in BATCH_01 ? "researched-product-batch-01" : null;
